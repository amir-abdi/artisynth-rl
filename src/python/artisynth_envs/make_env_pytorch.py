...
def _make_env_fn(env_id, seed, rank, log_dir, allow_early_resets, **kwargs):
    def _thunk():
...
def make_vec_envs(env_name, seed, num_processes, gamma, log_dir,
    ...
    for i in range(num_processes):
        ...
        envs.append(_make_env_fn(env_name, seed, i, log_dir, allow_early_resets, **vars(kwargs['args'])))
